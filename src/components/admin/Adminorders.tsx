...
// } from "react-icons/fa";
// import { deleteOrder } from "../../api/apiServices";
...
//                                 {/* Status filter pills */}
//                                 <div className="flex items-center gap-1.5">
//                                     // Replace the existing status filter pills with:
//                                     {["all", "paid", "failed", "pending", "processing", "shipped", "delivered", "cancelled"].map((s) => (
//                                         <button
//                                             key={s}
//                                             onClick={() => { setStatusFilter(s); setPage(1); }}
//                                             className={`text-[10px] px-3 py-1.5 rounded-full font-semibold capitalize transition-all border ${statusFilter === s
//                                                 ? s === "paid" ? "bg-green-100 text-green-800 border-green-300"
//                                                     : s === "failed" ? "bg-red-100 text-red-800 border-red-300"
//                                                         : s === "pending" ? "bg-yellow-100 text-yellow-800 border-yellow-300"
//                                                             : s === "delivered" ? "bg-emerald-100 text-emerald-800 border-emerald-300"
//                                                                 : s === "shipped" ? "bg-orange-100 text-orange-800 border-orange-300"
//                                                                     : s === "cancelled" ? "bg-red-100 text-red-800 border-red-300"
//                                                                         : s === "processing" ? "bg-indigo-100 text-indigo-800 border-indigo-300"
//                                                                             : "bg-white/20 text-[#E9DCCF] border-white/20"
//                                                 : "bg-transparent text-[#8B6F5E] border-transparent hover:bg-white/10"
//                                                 }`}
//                                         >
//                                             {s === "all" ? "All" : s}
//                                         </button>
...
//                                             pending: { color: "#C8A882", bg: "rgba(200,168,130,0.12)", glow: "rgba(200,168,130,0.3)", icon: <FaClock size={10} />, label: "Pending" },
//                                             processing: { color: "#8B84D7", bg: "rgba(99,102,241,0.1)", glow: "rgba(99,102,241,0.25)", icon: <FaBox size={10} />, label: "Processing" },
//                                             shipped: { color: "#A07040", bg: "rgba(160,112,64,0.12)", glow: "rgba(160,112,64,0.3)", icon: <FaTruck size={10} />, label: "Shipped" },
//                                             delivered: { color: "#3D7A5C", bg: "rgba(61,122,92,0.12)", glow: "rgba(61,122,92,0.3)", icon: <FaCheckCircle size={10} />, label: "Delivered" },
//                                             cancelled: { color: "#B94A4A", bg: "rgba(185,74,74,0.12)", glow: "rgba(185,74,74,0.3)", icon: <FaTimes size={10} />, label: "Cancelled" },
//                                         };
...
//                                                             style={isOpen
//                                                                 ? { background: "#3D2314", color: "#C8A882" }
//                                                                 : { background: "#F5EDE3", color: "#8B6F5E" }
//                                                             }
//                                                         >
//                                                             {isOpen ? "Close ↑" : "View ↓"}
//                                                         </button>
