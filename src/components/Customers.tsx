				...
				<div>
					...
					<div className="flex justify-between items-center p-8 -mt-12">
						<div className="flex items-center">
							...
							<h1 className="text-xl font-bold ml-2">CUSTOMERS</h1>
						</div>
						<button
